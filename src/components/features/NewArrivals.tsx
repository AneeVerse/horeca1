                        ...
                        {NEW_ARRIVALS.map((product) => (
                            ...
                            >
                                ...
                                <div className="mt-auto flex items-center justify-between gap-2">
                                    ...
                                    <button className="flex items-center gap-1.5 bg-[#2ca36a] text-white hover:bg-[#248f5c] px-3 py-1.5 md:px-4 md:py-2 rounded-lg text-[12px] font-bold transition-all whitespace-nowrap">
