...
export const MOCK_VENDORS: Vendor[] = [
    {
        ...
        creditEnabled: true,
        creditAmount: 25000,
        categories: ['Dairy', 'Paneer', 'Cheese', 'Butter'],
        isActive: true,
        description: 'Premium dairy supplier for hotels and restaurants across Mumbai.',
    },
    {
        id: 'v2',
        name: 'Metro Foods',
        ...
        creditEnabled: true,
        creditAmount: 50000,
        categories: ['Grocery', 'Sauces', 'Oils', 'Spices', 'Grains'],
        isActive: true,
        description: 'One-stop wholesale grocery for restaurants and cloud kitchens.',
    },
    {
        id: 'v3',
        name: 'Fresh Harvest',
        ...
        minOrderValue: 300,
        creditEnabled: false,
        categories: ['Vegetables', 'Fruits', 'Herbs', 'Salads'],
        isActive: true,
    ...
    },
    {
        ...
        creditEnabled: true,
        creditAmount: 15000,
        categories: ['Dairy', 'Milk', 'Curd', 'Paneer'],
        isActive: true,
        description: 'Traditional dairy products at wholesale prices.',
    },
    {
        id: 'v5',
        name: 'Spice Kingdom',
        ...
        minOrderValue: 750,
        creditEnabled: false,
        categories: ['Spices', 'Masalas', 'Dry Fruits', 'Herbs'],
        isActive: true,
        description: 'Bulk spices and masala blends for commercial kitchens.',
    },
    {
        id: 'v6',
        name: 'Bakers Hub',
        ...
        creditEnabled: true,
        creditAmount: 30000,
        categories: ['Bakery', 'Flour', 'Sugar', 'Essences', 'Chocolate'],
        isActive: true,
        description: 'Everything a bakery needs — flour, chocolate, and more.',
    },
];
...
export const MOCK_VENDOR_PRODUCTS: Record<string, VendorProduct[]> = {
    v1: [
        ...
        { ...productBase, id: 'p3', images: ['/images/category/milk.png'], name: 'Fresh Paneer', description: 'Farm fresh paneer', price: 320, category: 'Dairy', subcategory: 'Paneer', packSize: '1 kg', unit: 'kg', vendorId: 'v1', vendorName: 'Sharad Dairy', bulkPrices: [{ minQty: 5, price: 310 }], creditBadge: true, minOrderQuantity: 1 },
    ...
    v2: [
        ...
        { ...productBase, id: 'p11', images: ['/images/category/oils.png'], name: 'Olive Oil Extra Virgin', description: 'Cold pressed olive oil', price: 650, category: 'Oils', subcategory: 'Olive Oil', packSize: '1 L', unit: 'L', vendorId: 'v2', vendorName: 'Metro Foods', bulkPrices: [{ minQty: 3, price: 620 }], creditBadge: false, minOrderQuantity: 1, isDeal: true },
    ...
    v3: [
        ...
        { ...productBase, id: 'p14', images: ['/images/product/product-img5.png'], name: 'Onions', description: 'Premium quality onions', price: 35, category: 'Vegetables', subcategory: 'Onion', packSize: '1 kg', unit: 'kg', vendorId: 'v3', vendorName: 'Fresh Harvest', bulkPrices: [{ minQty: 10, price: 30 }], creditBadge: false, minOrderQuantity: 5 },
    ...
    v6: [
        ...
        { ...productBase, id: 'p23', images: ['/images/category/candy.png'], name: 'Dark Chocolate Couverture', description: '70% dark chocolate', price: 850, category: 'Bakery', subcategory: 'Chocolate', packSize: '1 kg', unit: 'kg', vendorId: 'v6', vendorName: 'Bakers Hub', bulkPrices: [{ minQty: 3, price: 810 }], creditBadge: true, minOrderQuantity: 1, isDeal: true },
...
export const MOCK_ORDER_LISTS: OrderList[] = [
    {
        ...
        items: [
            { productId: 'p1', product: MOCK_VENDOR_PRODUCTS.v1[0], defaultQty: 2, lastOrderedQty: 2 },
            { productId: 'p2', product: MOCK_VENDOR_PRODUCTS.v1[1], defaultQty: 1, lastOrderedQty: 1 },
            { productId: 'p3', product: MOCK_VENDOR_PRODUCTS.v1[2], defaultQty: 3, lastOrderedQty: 5 },
        ],
    ...
    },
    {
        ...
        items: [
            { productId: 'p7', product: MOCK_VENDOR_PRODUCTS.v2[0], defaultQty: 3, lastOrderedQty: 3 },
            { productId: 'p8', product: MOCK_VENDOR_PRODUCTS.v2[1], defaultQty: 5, lastOrderedQty: 5 },
            { productId: 'p9', product: MOCK_VENDOR_PRODUCTS.v2[2], defaultQty: 2, lastOrderedQty: 2 },
        ],
    ...
    },
    {
        ...
        vendorLogo: '/images/top vendors/vendor-logo6.png',
        items: [
            { productId: 'p22', product: MOCK_VENDOR_PRODUCTS.v6[0], defaultQty: 2, lastOrderedQty: 2 },
            { productId: 'p23', product: MOCK_VENDOR_PRODUCTS.v6[1], defaultQty: 1, lastOrderedQty: 1 },
        ],
        createdAt: new Date('2026-03-01'),
        updatedAt: new Date('2026-03-05'),
        lastUsed: new Date('2026-03-05'),
    },
];
