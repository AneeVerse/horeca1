    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <div className="md:hidden">
                ...
                <div className="relative -mt-14 z-20 bg-white rounded-t-[40px] px-6 pt-8 min-h-[500px] shadow-[0_-15px_30px_rgba(0,0,0,0.05)]">
                    {/* Category Tag */}
                    ...
                    <div className="mb-12">
                        ...
                        <div className="flex justify-start gap-1.5 px-4 mt-2 mb-4">
                    ...
                    {/* Mobile Action Bar (Non-Fixed) */}
                    <div className="flex items-center justify-between gap-4 py-5 safe-area-bottom mt-2">
                        {/* Quantity Selector */}
                        <div className="flex items-center gap-1.5 border border-gray-100 rounded-xl p-1 bg-gray-50/30">
                            <button
                                onClick={() => setQuantity(Math.max(1, quantity - 1))}
                                className="w-[38px] h-[38px] rounded-lg flex items-center justify-center text-[#2ca36a]"
                            >
                                <Minus size={18} strokeWidth={2.5} />
                            </button>
                            <div className="w-[44px] h-[38px] flex items-center justify-center text-[18px] font-[700] text-[#1e293b]">
                                {quantity}
                            </div>
                            <button
