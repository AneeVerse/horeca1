...
import { Loader2, Plus, Trash2, Users, Crown, Shield, Eye, Edit3 } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 pb-10 max-w-[800px]">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-[28px] font-bold text-[#000000] leading-none mb-1">Team</h1>
                    <p className="text-[#000000] text-[13px] font-medium opacity-70">Manage your vendor team members</p>
                </div>
                {isOwner && (
                    <button onClick={() => { setShowAddMember(true); setMemberError(null); }}
                        className="h-[44px] px-5 bg-[#299E60] text-white rounded-[12px] text-[14px] font-bold hover:bg-[#238a54] transition-colors flex items-center gap-1.5 shadow-sm">
