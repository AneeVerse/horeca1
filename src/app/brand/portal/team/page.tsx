...
import { Loader2, Users, Plus, Trash2, Crown, Shield, Edit3, Eye } from 'lucide-react';
        ...
        <div className="max-w-[700px] mx-auto space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-[#7C7C7C] font-medium mt-0.5 text-[14px]">Manage your brand team members</p>
                </div>
                {isOwner && (
                    <button onClick={() => { setShowAddMember(true); setMemberError(null); }}
                        className="h-[36px] px-4 bg-[#53B175] text-white rounded-[10px] text-[13px] font-bold hover:bg-[#3d9e41] transition-colors flex items-center gap-1.5 shadow-sm">
