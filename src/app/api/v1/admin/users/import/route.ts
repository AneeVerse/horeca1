            ...
            if (bizAccountId) {
              ...
              await tx.businessAccount.update({
                ...
                data: {
                  ...
                  businessSize: r.businessSize || undefined,
                  businessStructure: r.businessStructure || undefined,
                  serviceModel: r.serviceModel || undefined,
                  monthlyPurchaseBand: r.monthlyPurchaseBand || undefined,
                  procurementFrequency: r.procurementFrequency || undefined,
                  designation: r.designation || undefined,
                  leadStatus: r.leadStatus || undefined,
                  creditType: r.creditType || undefined,
                  ...(r.tags?.length ? { manualTags: r.tags } : {}),
                  ...(r.aiTags?.length ? { aiTags: r.aiTags } : {}),
                  ...(r.behaviourTags?.length ? { behaviourTags: r.behaviourTags } : {}),
                },
              });
              ...
              const account = await tx.businessAccount.create({
                data: {
                  ...
                  businessSize: r.businessSize || null,
                  businessStructure: r.businessStructure || null,
                  serviceModel: r.serviceModel || null,
                  monthlyPurchaseBand: r.monthlyPurchaseBand || null,
                  procurementFrequency: r.procurementFrequency || null,
                  designation: r.designation || null,
                  leadStatus: r.leadStatus || null,
                  creditType: r.creditType || null,
                  manualTags: r.tags ?? [],
                  aiTags: r.aiTags ?? [],
                  behaviourTags: r.behaviourTags ?? [],
                  isCustomer: true,
                },
              });
